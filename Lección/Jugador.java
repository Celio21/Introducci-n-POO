...
public class Jugador {
    ...
    public static void main(String[] args) {
        Jugador j = new Jugador("Kubo", "Nosequemas", 33, 520, 2005, new Equipo("Real Madrid", 33, "Tunin"));
        Jugador j2 = new Jugador("lionel", "messi", 31, 600, 2007, new Equipo("barcelona", 30, "barcelona"));
        Jugador j3 = new Jugador("Kilam", "Mpbape", 28, 200, 2011, new Equipo("psg", 10, "paris"));
